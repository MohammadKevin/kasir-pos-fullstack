    ...
    <main className="min-h-screen bg-slate-50/50 flex items-stretch antialiased font-sans select-none">
      ...
      <div className="hidden lg:flex lg:w-[42%] bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 text-white p-12 flex-col justify-between relative overflow-hidden shrink-0 select-none">
        ...
        <div className="relative z-10 flex items-center gap-2">
          <div className="h-7 w-7 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white flex items-center justify-center font-black text-sm shadow-md shadow-blue-500/30">
            N
          </div>
          <span className="font-extrabold text-sm tracking-tight text-white">
            Nova<span className="text-cyan-400">POS</span>
            <span className="ml-2 text-[8px] font-black uppercase tracking-widest text-cyan-300 bg-cyan-500/20 border border-cyan-400/35 px-1.5 py-0.5 rounded-md leading-none">CLOUD OS</span>
          </span>
        </div>

        <div className="relative z-10 my-auto space-y-8">
          <div className="space-y-3">
            <h2 className="text-2xl font-black leading-snug">Sistem ERP & POS Modern Terintegrasi</h2>
            <p className="text-slate-350 text-xs font-medium leading-relaxed max-w-sm">
              Kelola kasir, pengawasan multi-outlet, kontrol inventaris real-time, pencetakan barcode, dan laporan keuangan komprehensif dalam satu platform cerdas.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-4 shadow-xl space-y-3.5 max-w-sm">
            <div className="flex justify-between items-center border-b border-white/5 pb-2">
              <span className="text-[9px] font-extrabold uppercase tracking-widest text-cyan-300">Status Layanan Cloud</span>
              <span className="flex items-center gap-1">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-[7.5px] font-bold text-emerald-400 uppercase">ONLINE 99.9%</span>
              </span>
            </div>
            
            <div className="flex justify-between items-end">
              <div>
                <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider">Cloud Engine</p>
                <p className="text-sm font-bold tracking-tight text-white mt-1">NovaPOS Core Engine v2.0</p>
              </div>
              <div className="flex items-center gap-1.5 text-[8.5px] font-bold text-cyan-400 bg-cyan-500/10 rounded-full px-2 py-0.5 border border-cyan-500/20">
            ...
            <div className="flex gap-2">
              ...
              <div className="flex-1 bg-white/5 rounded-lg p-2 border border-white/5">
                <p className="text-[7.5px] text-slate-400">Multi-Outlet</p>
                <p className="text-xs font-bold mt-0.5 text-slate-200">Tersinkron</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2.5 text-xs font-semibold text-slate-350">
            <div className="flex items-center gap-2">
              ...
              <span>Akses Keamanan Standar SSL/TLS 256-bit Encrypted</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 size={13} className="text-cyan-400 shrink-0" />
              <span>Audit Log & Backup Otomatis Real-Time</span>
            </div>
          </div>
        ...
        <div className="relative z-10 text-[9.5px] text-slate-400 font-bold tracking-wide flex justify-between items-center border-t border-white/5 pt-4">
          <span>NovaPOS Cloud Platform</span>
      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-12 md:px-24 bg-white">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-[10px] text-slate-400 font-extrabold uppercase tracking-wider lg:hidden">NovaPOS Cloud</span>
        </div>

        <div className="w-full max-w-sm mx-auto my-auto space-y-6">
          
          <div className="space-y-1.5 text-center sm:text-left">
            <h1 className="text-xl sm:text-2xl font-black text-slate-950 tracking-tight">Login Portal</h1>
            <p className="text-slate-500 text-xs font-medium">Masuk untuk mengakses dasbor admin atau terminal POS outlet.</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-4">
            
            <div className="space-y-1.5">
              <label className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400">Email Akun</label>
              <input
                type="email"
                required
                value={email}
          ...
          <div className="bg-slate-50 border border-slate-200/60 rounded-xl p-3.5 text-[10.5px] font-semibold text-slate-500 leading-relaxed mt-4 flex items-start gap-2">
            ...
            <span>
              <strong>Pemberitahuan Keamanan:</strong> Portal ini ditujukan untuk pengguna sistem NovaPOS. Jika Anda membutuhkan akun baru atau kendala akses, silakan hubungi <strong>Administrator Sistem</strong>.
            </span>
          </div>
        ...
        <div className="text-center text-[10px] text-slate-400 font-semibold mt-8 border-t border-slate-100 pt-4 flex justify-center items-center gap-2">
          <span>NovaPOS Cloud Platform • Hak Cipta © {new Date().getFullYear()}</span>
        </div>
