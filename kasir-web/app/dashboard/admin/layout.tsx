        ...
        <div className="flex flex-col flex-1 overflow-y-auto pr-0.5 scrollbar-thin">
          ...
          <div className={`mb-6 flex items-center justify-between ${isSidebarCollapsed ? 'px-2 justify-center' : 'px-3'}`}>
            <div className="flex items-center gap-2">
              {!isSidebarCollapsed && (
                <div className="flex items-center gap-2">
                  <div className="h-7 w-7 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-black text-xs shadow-md shadow-blue-500/30">
                    N
                  </div>
              ...
              {isSidebarCollapsed && (
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-black text-sm shadow-md shadow-blue-500/30">
                  N
                </div>
              )}
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5">
              <div className="text-right hidden md:block">
                ...
                <p className="text-[9px] text-blue-500 font-bold leading-none mt-0.5">
                  NovaPOS Cloud
                </p>
              </div>
