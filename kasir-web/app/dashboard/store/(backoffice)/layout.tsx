...
export default function StoreLayout({
  ...
  const [staffName, setStaffName] = useState('Staff POS')
          ...
          <div className="space-y-6 flex-1 overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex gap-2 items-center">
                <div className="h-6 w-6 rounded-lg bg-gradient-to-br from-blue-600 to-cyan-500 text-white flex items-center justify-center font-black text-xs shadow-md shadow-blue-500/20">
                  N
                </div>
