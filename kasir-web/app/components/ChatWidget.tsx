            ...
            <div className="flex items-center gap-2 min-w-0">
              {selectedContact ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-xs font-black tracking-tight">NovaPOS Team Chat</h4>
                    <p className="text-[9px] text-slate-400 font-semibold leading-none mt-0.5">Komunikasi & koordinasi operasional tim</p>
                  </div>
                </div>
              )}
            </div>
